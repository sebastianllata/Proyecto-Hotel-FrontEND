...
const routes: Routes = [
  ...
  {path: 'empleado', component: EmpleadoComponent,canActivate:[AuthrutasGuard, RoleGuard], data:{role:'ADMIN'}},
  {path: 'footer', component:FooterComponent,canActivate:[AuthrutasGuard,RoleGuard], data:{role:'ADMIN'}}
